...
# config.MODEL.PRETRAINED = './pretrained_models/resnet50-19c8e357.pth' # resnet101-5d3b4d8f.pth  # resnet152-b121ed2d.pth # resnet50-19c8e357.pth
config.MODEL.PRETRAINED_MOBILENETV2_IMAGENET = './pretrained_models/mobilenet_v2.pth.tar'
config.MODEL.PRETRAINED_teacher = './model_res50_deconv_teacher.pth.tar'
config.MODEL.PRETRAINED_MOBILENETV2_STUDENT = ''
config.MODEL.NUM_JOINTS = 68*2 # zhaoyang
