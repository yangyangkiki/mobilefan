...
def crop(img, center, scale, res, rot=0):
    img = im_to_numpy(img)  # between (0-1) H*W*C float32
    ...
    if sf < 2:
        ...
        if new_size < 2:
            ...
            center_1[0] = center_1[0] * 1.0 / sf
            center_1[1] = center_1[1] * 1.0 / sf
            scale = scale / sf

    # Upper left point
    ul = np.array(transform([0, 0], center_1, scale, res, invert=1))
    # Bottom right point
    br = np.array(transform(res, center_1, scale, res, invert=1))
