...
class MobileNetV2_Deconv_Features(nn.Module):
    def __init__(self, cfg, input_size=256, width_mult=1.): #n_class=1000,
        ...
        # self.features.append(conv_1x1_bn(input_channel, self.last_channel)) # 320-->1280
        ...
        # self._initialize_weights(cfg.MODEL.PRETRAINED_MOBILENETV2) # initial mobilenetv2 parameters
